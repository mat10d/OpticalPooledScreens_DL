...
#SBATCH --gres=gpu:1
#SBATCH --mem=4G
#SBATCH --output=out/vgg_classify_%j.out

source /lab/barcheese01/miniconda3/etc/profile.d/conda.sh

conda activate ops_dl

VGG_PATH="/lab/barcheese01/mdiberna/OpticalPooledScreens_DL/scripts/train/train_vgg_classifier.py"
